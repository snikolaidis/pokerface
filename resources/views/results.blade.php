            ...
            <div class="card">
                ...
                <div class="card-body results">
                    ...
                    <div class="row">
                        ...
                        <div class="col-6"><img src="/images/wins.png" class="img-fluid ${3|rounded-top,rounded-right,rounded-bottom,rounded-left,rounded-circle,|}" alt=""></div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-6"><img src="/images/royal_flush.png" class="img-fluid ${3|rounded-top,rounded-right,rounded-bottom,rounded-left,rounded-circle,|}" alt=""></div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-6"><img src="/images/straight_flush.png" class="img-fluid ${3|rounded-top,rounded-right,rounded-bottom,rounded-left,rounded-circle,|}" alt=""></div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-6"><img src="/images/four_of_a_kind.png" class="img-fluid ${3|rounded-top,rounded-right,rounded-bottom,rounded-left,rounded-circle,|}" alt=""></div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-6"><img src="/images/full_house.png" class="img-fluid ${3|rounded-top,rounded-right,rounded-bottom,rounded-left,rounded-circle,|}" alt=""></div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-6"><img src="/images/flush.png" class="img-fluid ${3|rounded-top,rounded-right,rounded-bottom,rounded-left,rounded-circle,|}" alt=""></div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-6"><img src="/images/straight.png" class="img-fluid ${3|rounded-top,rounded-right,rounded-bottom,rounded-left,rounded-circle,|}" alt=""></div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-6"><img src="/images/three_of_a_kind.png" class="img-fluid ${3|rounded-top,rounded-right,rounded-bottom,rounded-left,rounded-circle,|}" alt=""></div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-6"><img src="/images/two_pair.png" class="img-fluid ${3|rounded-top,rounded-right,rounded-bottom,rounded-left,rounded-circle,|}" alt=""></div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-6"><img src="/images/one_pair.png" class="img-fluid ${3|rounded-top,rounded-right,rounded-bottom,rounded-left,rounded-circle,|}" alt=""></div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-6"><img src="/images/high_card.png" class="img-fluid ${3|rounded-top,rounded-right,rounded-bottom,rounded-left,rounded-circle,|}" alt=""></div>
